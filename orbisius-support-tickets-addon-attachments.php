...
define("ORBISIUS_SUPPORT_TICKETS_ATTACHMENTS_ADDON_FILES_DIR", WP_CONTENT_DIR . "/.ht_orbisius-support-tickets/files/");
define("ORBISIUS_SUPPORT_TICKETS_ATTACHMENTS_ADDON_FILES_URL", WP_CONTENT_URL . "/.ht_orbisius-support-tickets/files/");
